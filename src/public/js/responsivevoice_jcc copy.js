...
Array.from || (Array.from = function() {
    ...
    return function(f) {
        ...
        for (var c = l(this) ? Object(new this(b)) : Array(b), d = 0, e; d < b; )
            e = a[d],
            c[d] = p ? "undefined" === typeof r ? p(e, d) : p.call(r, e, d) : e,
            d += 1;
        c.length = b;
        return c
    }
                    ...
                    if (a.checkSpeechAllowed()) {
                        ...
                        for (g = 0; g < n.length; g++)
                            if (!a.fallbackMode && a.getServiceEnabled(a.services.NATIVE_TTS))
                                ...
                                e.rate = a.selectBest([a.iOS9plus ? 1 : null, h.collectionvoice.rate, h.systemvoice.rate, 1]),
                                ...
                                g < n.length - 1 && 1 < n.length ? (e.onend = a.onPartEnd,
                                ...
                                q = a.selectBest([h.collectionvoice.volume, h.systemvoice.volume, 1]);
                                if (null != d) {
                                ...
                                m = "?t=" + encodeURIComponent(n[g]) + "&tl=" + (h.collectionvoice.lang || h.systemvoice.lang || "en-US") + "&sv=" + (h.collectionvoice.service || h.systemvoice.service || "") + "&vn=" + (h.collectionvoice.voicename || h.systemvoice.voicename || "") + "&pitch=" + e.toString() + "&rate=" + k.toString() + "&vol=" + q.toString();
